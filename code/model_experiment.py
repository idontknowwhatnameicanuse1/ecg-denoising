...
def create_DDPM_model():
    ...
    original_time_embedding=tf.expand_dims(input_layer[:,:,1],axis=-1)
    # none*1024*2   1196
    output_1=conv_block(units=64,kernel_size=3)(input_layer)
    # none*1024*64  1192
    input_2=MaxPooling1D(strides=2)(output_1)
    time_embedding_input_2=MaxPooling1D(strides=2)(original_time_embedding)
    # none*512*64   596
    input_2=Concatenate(axis=2)([input_2,time_embedding_input_2])
    output_2=conv_block(units=128,kernel_size=3)(input_2)
    # none*512*128  592
    input_3=MaxPooling1D(strides=2)(output_2)
    time_embedding_input_3=MaxPooling1D(strides=2)(time_embedding_input_2)
    # none*256*128  296
    input_3=Concatenate(axis=2)([input_3,time_embedding_input_3])
    output_3=conv_block(units=256,kernel_size=3)(input_3)
    # none*256*256  292
    input_4=MaxPooling1D(strides=2)(output_3)  # pool_size=2
    time_embedding_input_4=MaxPooling1D(strides=2)(time_embedding_input_3)
    # none*128*256  146
    input_4=Concatenate(axis=2)([input_4,time_embedding_input_4])
    output_4=conv_block(units=512,kernel_size=3)(input_4)
    # none*128*512  142
    input_5=MaxPooling1D(strides=2)(output_4)
    time_embedding_input_5=MaxPooling1D(strides=2)(time_embedding_input_4)
    # none*64*512   71
    input_5=Concatenate(axis=2)([input_5,time_embedding_input_5])
    output_5=conv_block(units=1024,kernel_size=3)(input_5)
    # none*64*1024  67
    input_6=Conv1DTranspose(filters=512,strides=2,kernel_size=2)(output_5) # kernel_size=2
    time_embedding_input_6 = time_embedding_input_4
    # none*128*512  135
    ...
    # none*128*1024 135
    input_6=Concatenate(axis=2)([input_6,time_embedding_input_6])
    output_6=conv_block(units=512,kernel_size=3)(input_6)
    # none*128*512  131
    input_7=Conv1DTranspose(filters=256,strides=2,kernel_size=2)(output_6) # kernel_size=2
    time_embedding_input_7 = time_embedding_input_3
    # none*256*256  263
    ...
    input_8=Concatenate(axis=2)([input_8,time_embedding_input_8])
    ...
    time_embedding_input_9 = original_time_embedding
    ...
    input_9=Concatenate(axis=2)([input_9,time_embedding_input_9])
